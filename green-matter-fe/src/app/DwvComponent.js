...
decoderScripts.jpeg2000 = `${publicUrl}/assets/dwv/decoders/pdfjs/decode-jpeg2000.js`;
decoderScripts["jpeg-lossless"] = `${publicUrl}/assets/dwv/decoders/rii-mango/decode-jpegloss.js`;
decoderScripts["jpeg-baseline"] = `${publicUrl}/assets/dwv/decoders/pdfjs/decode-jpegbaseline.js`;
decoderScripts.rle = `${publicUrl}/assets/dwv/decoders/dwv/decode-rle.js`;
